...
export const PROJECTS: Project[] = [
  ...
  { id: 'spider', kind: 'product', title: 'SpiderWaterReminder', description: 'A desktop companion that makes hydration and breaks part of the day, with scheduled reminders, quiet hours, and templates.', tags: ['Electron', 'JavaScript'], githubUrl: 'https://github.com/raselislam29/SpiderWaterReminder', liveUrl: 'https://spider-water-reminder.vercel.app' },
  { id: 'openhousesync', kind: 'app', title: 'OpenHouseSync', description: 'A workspace for listing agents running open houses: digital visitor sign-in, NY disclosures, and a feedback engine that follows up with buyers and cooperating agents after the event.', tags: ['React 19', 'TypeScript', 'Firebase', 'Resend'], githubUrl: 'https://github.com/raselislam29/openhousesync' },
  { id: 'library', kind: 'app', title: 'Library Management System', description: 'A JavaFX desktop app with Firebase Auth and role-based dashboards for admins, librarians, and members, covering catalog search, borrowing and returns, and overdue alerts.', tags: ['Java', 'JavaFX', 'Firebase'], githubUrl: 'https://github.com/raselislam29/Library-Management-System' },
  ...
  { id: 'covid', kind: 'data', title: 'COVID-19 Vaccination Analysis', description: 'Analyzed global vaccination data from Kaggle to compare country progress, daily trends, and vaccine brands by region.', tags: ['Python', 'Pandas', 'Seaborn'], githubUrl: 'https://github.com/raselislam29/covid-vaccine-analysis' },
];
